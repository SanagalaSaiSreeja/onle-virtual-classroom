...
function Header(props) {
  ...
  const [studentResults,setStudentsResults]=useState("");
  ...
  return (
    ...
    <div>
                      ...
                      {assignments.map((assignment) => (
                        ...
                        <li className="assignment-item" key={assignment._id}>
                          ...
                          {assignment.submission && (
                            <>
                              Assignment Submitted by: {assignment.submission}
                            </>
                          )}
                          {assignment.filename && (
                            <a style={{
                    ...
                    >
                      <ul>
                        {quizzes.map((quiz, index) => (
                          <li key={index}>
                            <p>New Student attempted quiz for {quiz.title}</p> 
                            <Link to="/QuizForm" className="btn-noti"
                            style={{
                              height: "35px",
                              width: "30%",
                              border: "none",
                    ...
                    >
                      ...
                      >
                        ...
                        <li className="assignment-item" key={assignment._id}>
                          ...
                          {assignment.submission && (
                            <>
                              Assignment Created by: {assignment.submission}
                            </>
                          )}
                          {assignment.filename && (
                            <a style={{
                    ...
                    >
                      ...
                      >
                        <ul>
                          {quizzes.map((quiz, index) => (
                            <li key={index}>
                              <p>{quiz.title} Quiz was Assigned</p>
      ...
      borderRadius:10, color:"white"}}>
          ...
          <i onClick={()=>navigate("/Assignment")} style={{fontSize:"23px"}} className='fa fa-tasks'></i>
            <i onClick={()=>navigate("/Allcourses")} style={{fontSize:"23px"}} class="fa fa-graduation-cap" ></i>
            <i onClick={()=>navigate("/QuizForm")} style={{fontSize:"23px"}} className='fa fa-puzzle-piece'></i>
